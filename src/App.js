...
import Mian from './component/search/forecast/Main';
...
function App() {
  ...
  return (
    ...
    {currentWeather ?
      <div class="display main-container flex flex-col md:flex-row gap-6  p-2 md:p-11  rounded-3xl m-auto mt-11 w-[95%] md:w-[55%]">  
